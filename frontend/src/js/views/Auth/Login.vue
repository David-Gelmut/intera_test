  ...
  <div class="min-h-screen flex flex-col justify-center items-center bg-slate-50 px-4 sm:px-6 lg:px-8 font-sans text-slate-800 antialiased">
    <div class="w-full max-w-md space-y-8">
      ...
      <div class="text-center">
        ...
        <p class="mt-2 text-sm text-slate-500">Войдите в свой аккаунт для продолжения</p>
      </div>

      <!-- Карточка авторизации -->
      <div class="bg-white rounded-xl shadow-md border border-slate-200/80 p-6 sm:p-8">
        <h3 class="text-lg font-bold text-slate-900 mb-6">Авторизация</h3>
        ...
        <div class="mt-5 text-center text-sm">
          ...
          <router-link to="/register" class="ml-1 font-semibold text-blue-600 hover:text-blue-500 transition-colors">
            Зарегистрироваться
          </router-link>
        </div>
